...
import static com.zgj.mps.generator.ZbootGenerator.*;
...
* creat_user: ZhangGaoJun@zhanggj@zgj.cn
* creat_date: 2019/7/8
* creat_time: 15:53
**/
@Slf4j
public class ZbootMPGenerator {
     ...
     * 建议仅需修改
     */
    private static final String className = "DeviceStatus";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "在线设备";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.zgj.mps.model";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.zgj.mps.dao.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.zgj.mps.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.zgj.mps.service.impl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.zgj.mps.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/zgj/mps/generator/template";
